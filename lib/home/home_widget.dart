            ...
            children: [
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    child:
                        const MenuItem(icon: 'asset/bayar.png', text: 'Bayar'),
                  ),
                  GestureDetector(
                    onTap: () => Get.to(() => const KrsView(),
                        transition: Transition.cupertino, arguments: mahasiswa),
                    child: const MenuItem(icon: 'asset/krs.png', text: 'KRS'),
                  ),
                  GestureDetector(
                    child: const MenuItem(
                        icon: 'asset/jadwal.png', text: 'Jadwal'),
                  ),
                  GestureDetector(
                    child:
                        const MenuItem(icon: 'asset/nilai.png', text: 'Nilai'),
                  )
                ],
              ),
              const SizedBox(
                ...
                children: controller.berita.map((e) {
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        color: indicator == index ? Colors.blue : Colors.grey),
                  );
                }).toList(),
              ),
              const SizedBox(
